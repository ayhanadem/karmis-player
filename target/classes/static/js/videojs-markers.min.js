...
!function (e, r) {
    ...
    var x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        markerStyle: {width: "7px", "border-radius": "30%", "background-color": "red"}, markerTip: {
    ...
    h.default.registerPlugin("markers", function (n) {
        ...
        function y(e, r)
        {
            ...
            if ((t < 0 || 1 < t) && (r.style.display = "none"), r.style.left = v(e) + "%", e.duration) r.style.width = e.duration / s.duration() * 100 + "%", r.style.marginLeft = "0px"; else
            {
                var i = T(r);
